...
const buttonClasses = computed(() =>
  props.variant === "floating"
    ? "inline-flex h-12 w-12 items-center justify-center rounded-full border border-slate-200/60 bg-white/80 text-slate-700 shadow-lg backdrop-blur-sm ring-1 ring-slate-900/5 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:border-brand/30 dark:border-slate-600/60 dark:bg-slate-800/90 dark:text-slate-100 dark:hover:bg-slate-700 dark:hover:border-brand-light/30"
    : "flex items-center gap-2 rounded-full border border-slate-200/60 bg-white/80 px-3.5 py-1.5 text-xs font-semibold text-slate-600 shadow-sm backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-brand/30 hover:bg-white hover:shadow-md dark:border-slate-600/60 dark:bg-slate-800/80 dark:text-slate-100 dark:hover:border-brand-light/30 dark:hover:bg-slate-700",
);
</script>
